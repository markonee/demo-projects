...
{
    public class MedicinskiTehnicar : Uposlenik
    {
        private static double plata = 1000;
        public MedicinskiTehnicar() : base() { }
        public MedicinskiTehnicar(string ime, string prezime, string odjel, double plata, string korisnickoIme, string lozinka)
