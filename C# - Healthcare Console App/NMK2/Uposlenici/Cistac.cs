...
{
    public class Cistac : Uposlenik
    {
        private static double plata = 800;
        public Cistac() : base() { }
        public Cistac(string ime, string prezime, string odjel, double plata, string korisnickoIme, string lozinka)
